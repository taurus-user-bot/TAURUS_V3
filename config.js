...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'MUHAMMED' : process.env.OWNER_NAME,
    BC: process.env.BROADCAST_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴛᴀᴜʀᴜs_ᴠ3࿐' : process.env.BROADCAST_NAME,
    PHONE: process.env.NUMBER === undefined ? '918157849715' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'MUHAMMED' : process.env.DEPLOYER,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'TAURUS_V3' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '‒‒‒TAURUS_V3‒‒‒' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'TAURUS: process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://bit.ly/3cwa8fv' : process.env.ALL_IMG,
    SKDL: process.env.DIALOGUE === undefined ? 'Taurus Says I Love U' : process.env.DIALOGUE,
    JID: process.env.VERIFIED === undefined ? '9961050829@s.whatsapp.net' : process.env.VERIFIED,
    ...
    TALKING_TAURUS: process.env.TALKING_TAURUS === undefined ? 'false' : process.env.TALKING_TAURUS,
    ...
    YAK: process.env.YAK === undefined ? '918157849715,0,919961050829,0,' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
